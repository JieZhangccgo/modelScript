...
%%
msInfo.icMesh = [0 0.39 0.41 0.59 0.61 1];
...
msInfo.yMesh = [0 0.2 0.3 0.6 0.8 1];
% Define a matrix data_Deff of sampling values vectors v1..v4
msInfo.Deff = [0.5 0.6 0.7 0.8 0.6 0.5; ...%CO2--1
...
msInfo.thetaData = [0.5 0.6 0.7 0.8 0.6 0.5; ...%CO2--1
    0.5 0.6 0.7 0.8 0.6 0.5; ...%DOC--2
